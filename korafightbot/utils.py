...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"korafightbot/modules/{shortname}.py")
        name = "koafightbot.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        # for imports
        sys.modules["koafightbot.modules." + shortname] = mod
        LOGS.info("Successfully imported " + shortname)
...
def remove_plugin(shortname):
    try:
        try:
            ...
            name = f"koafightbot.modules.{shortname}"
